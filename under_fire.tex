...
\npccontinued{0}{0}{
   ...
   \begin{itemize}
       ...
       \item Venomous Pincers - If Swarm successfully hits a PC for enough damage to get through Soak, that PC must make at Average [\df\df] \textbf{Resilience} check or be disoriented (+\setback) for 3 rounds.
   \end{itemize}}
...
\npccontinued{0}{0}{
   ...
   Abilities:
   \begin{itemize}
       \item Burrow - Average [\df\df] \textbf{Coordination} to dig into the rock to escape
