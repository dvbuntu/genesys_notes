...
\begin{GenesysTable}{p{1.5in}p{2in}}
    Approach & \\
    \df\df\stb \textbf{Knowledge (Mundane)} to understand Andre/Breaux's relationship & Andre's concern goes beyond roommates.  They are boyfriends.+\bbb to \textbf{Negotiate}\\
...
\begin{itemize}
    \setlength\itemsep{-.5em}
        ...
        \item \Advantage\Advantage: Every two advantages constitute profit they can use to use for +\bb on future social checks or longer term needs.
...
After signing the contract, Andre leaves quickly to get back to work.  The PCs have picture of Breaux and Andre together from a mall photobooth kiosk as well as the address for Breaux's haunted workshop.
