...
\npccontinued{0}{0}{
   ...
   \begin{itemize}
       ...
       \item Venomous Bite - If Scarab Swarm successfully hits a character, that character must make at \df\df Resilience check or be disoriented (+\stb) for 3 rounds.
   \end{itemize}}
