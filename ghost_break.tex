...
Depending where emerge, may also find GeisterTruppen setting up some ghost release/possession equipment behind Allied lines.  
...
\npccontinued{1}{1}{
   ...
   \begin{itemize}
       \item Adversary 1
       \item Big Pistol (6 dmg, acc 1, med range, crit 3)
       \item Knife (+1 dmg, crit 3)
   \end{itemize}}
