...
As the workshop is locked, the PCs will have to find some way inside.  They can try picking a lock, climbing through a tight window, forcing a door, or something more creative.  Once one PC succeeds, they can let the others in.
...
\end{GenesysTable}
Trenchcoat animated by \ai.  They are very agile and adept at entangling enemies in their sleeves like a straightjacket.
   }
