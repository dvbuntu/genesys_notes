...
If the PCs fail all these checks, still let them in, but with no bonus.  Also add +\stb to all subsequent checks as it darkens further.  The town clocktower strikes an hour later than anyone thought as the sky darkens.
