...
\begin{quote}
\emph{State the nature of your business in Pinyumb and transmit your crew identifications.}
\end{quote}
...
\begin{quote}
\emph{Responding with flight path and docking permit.
...
\success It’s just crews loading and unloading, no one paying any special attention to the PCs. The few guards standing around near the exits are wearing corporate uniforms, not stormtrooper armor. If there’s an Imperial presence here, it’s light.
    \failure PCs think they have attracted attention of local security
    \threat A detail that suggests heavier Imperial presence
...
%   \emph{Drutash Scarab Swarm Rival} \\ %name
...
\npccontinued{0}{0}{
   ...
   Abilities:
   \begin{itemize}
       \item Swarm - Unless an attack has the Blast or Burn quality (regardless of if it is activated), halve the damage before applying soak
       \item Venomous Pincers - If Swarm successfully hits a PC for enough damage to get through Soak, that PC must make at Average [\df\df] Resilience check or be disoriented (+\setback) for 3 rounds.
   \end{itemize}}
...
Average [\df\df] Perception or Hard [\df\df\df] Vigilance to see flash of miners’ lamp lights. 

\npc{Aadlan Myder}{2}{2}{2}{2}{3}{3}{12}{3}
%   \emph{Aadlan Myder} \\ %name
%   \Characteristics{2}{2}{2}{2}{3}{3}\\
%   \DerivedSplit{Health}{12}{3}{Wounds}{Soak} % wounds/soak
\npccontinued{0}{0}{
   Skills:
   \begin{itemize}
        \item Cool 1
...
Hard [\df\df\df] Knowledge (Xenology): Rockrender isn’t the danger, the paths it opens are, as lava flows quickly through those.
...
\npccontinued{0}{0}{
   ...
   Abilities:
   \begin{itemize}
       \item Burrow - Average [\df\df] Coordination to dig into the rock to escape
...
Need 3 successful Hard [\df\df\df] Athletics checks to get all the miners out before the chamber floods with magma.  Failure to do so means either a PC suffers a critical injury to rescue a miner, or the Sullustans lose trust in the PCs (and possibly the Rebel Alliance).
...
\begin{quote}
\emph{Make it public. They can’t assassinate me without plausible deniability.
...
\npc{Ub Nub}{2}{2}{2}{3}{3}{3}{2}{12}
%   \emph{Ub Nub Corrupt Bureaucrat Rival} \\ %name
%   \Characteristics{2}{2}{2}{3}{3}{3}\\
%   \DerivedSplit{Health}{12}{2}{Wounds}{Soak} % wounds/soak
\npccontinued{0}{0}{
   Skills:
   \begin{itemize}
       \item Charm 2
